...
def _default_config():
    return {
        ...
        "handsets_desktop": [
            {"name": "Grandstream GRP2601P",    "buy": 38.00,  "poe": True,  "cat": "Desktop"},
            {"name": "Grandstream GRP2602P",    "buy": 48.00,  "poe": True,  "cat": "Desktop"},
            {"name": "Grandstream GRP2603P",    "buy": 62.00,  "poe": True,  "cat": "Desktop"},
            {"name": "Grandstream GRP2615",     "buy": 88.00,  "poe": True,  "cat": "Desktop"},
            {"name": "Grandstream GRP2616",     "buy": 98.00,  "poe": True,  "cat": "Desktop"},
            {"name": "Grandstream GXV3350",     "buy": 165.00, "poe": True,  "cat": "Desktop"},
            {"name": "Grandstream GXV3470",     "buy": 248.00, "poe": True,  "cat": "Desktop"},
            {"name": "Grandstream GXV3480",     "buy": 310.00, "poe": True,  "cat": "Desktop"},
        ],
        "handsets_cordless": [
            {"name": "Grandstream DP720",        "buy": 38.00,  "bogof": False, "cat": "DECT"},
            {"name": "Grandstream DP722",        "buy": 48.00,  "bogof": False, "cat": "DECT"},
            {"name": "Grandstream DP730",        "buy": 62.00,  "bogof": False, "cat": "DECT"},
            {"name": "Grandstream DP750 (Base)", "buy": 68.00,  "bogof": False, "cat": "DECT"},
            {"name": "Grandstream DP752 (Base)", "buy": 78.00,  "bogof": False, "cat": "DECT"},
        ],
        "headsets": [
        ...
        "other_hardware": [
            {"name": "Grandstream GWN7660LR (Wi-Fi AP)", "buy": 75.25},
            {"name": "Fanvil ATA GA11",                  "buy": 26.97},
            {"name": "Hosiden Loud Bell (Hbl Bedlam)",   "buy": 75.63},
            {"name": "Fanvil i67 Door Entry",            "buy": 349.38},
            {"name": "Yealink RT30 DECT Extender",       "buy": 78.24},
            {"name": "Yealink EXP55 Expansion Module",   "buy": 59.99},
            {"name": "Yealink PSU 6W",                   "buy": 6.71},
            {"name": "Yealink PSU 10W",                  "buy": 7.66},
            {"name": "POE Injector",                     "buy": 14.00},
            {"name": "TP Link Deco (Pack of 3)",         "buy": 90.50},
            {"name": "Poynting 4G/5G Antenna",           "buy": 64.37},
            {"name": "Poynting Antenna Cable 10M",       "buy": 37.02},
        ],
        "switches": [
        ...
        "broadband": [
            {"provider": "Gamma",         "package": "SoGEA Single Line",  "cost": 26.05, "install": 78.96},
            {"provider": "Gamma",         "package": "FTTP 40:10",          "cost": 26.06, "install": 71.61},
            {"provider": "Gamma",         "package": "FTTP 80:20",          "cost": 25.15, "install": 71.61},
            {"provider": "Gamma",         "package": "FTTP 160:30",         "cost": 26.48, "install": 71.61},
            {"provider": "Gamma",         "package": "FTTP 220:30",         "cost": 26.72, "install": 71.61},
            {"provider": "Gamma",         "package": "FTTP 330:50",         "cost": 28.69, "install": 71.61},
            {"provider": "Gamma",         "package": "FTTP 500:165",        "cost": 186.37,"install": 71.61},
            {"provider": "Gamma",         "package": "FTTP 1GB:115",        "cost": 279.29,"install": 71.61},
            {"provider": "ITS (FibreOne)","package": "FibreOne 80:20",      "cost": 27.00, "install": 152.00},
            {"provider": "ITS (FibreOne)","package": "FibreOne 160:30",     "cost": 32.00, "install": 152.00},
            {"provider": "ITS (FibreOne)","package": "FibreOne 330:50",     "cost": 36.00, "install": 152.00},
            {"provider": "ITS (FibreOne)","package": "FibreOne 550:75",     "cost": 40.00, "install": 152.00},
            {"provider": "ITS (FibreOne)","package": "FibreOne 1GB:115",    "cost": 45.00, "install": 152.00},
            {"provider": "ITS (FibreOne)","package": "FibreOne 1.2GB:120",  "cost": 48.00, "install": 152.00},
            {"provider": "ITS (FibreOne)","package": "FibreOne 1.8GB:120",  "cost": 52.00, "install": 152.00},
            {"provider": "ITS (FibreOne)","package": "FibreLight 100:100",  "cost": 43.00, "install": 152.00},
            {"provider": "ITS (FibreOne)","package": "FibreLight 500:500",  "cost": 75.00, "install": 152.00},
            {"provider": "ITS (FibreOne)","package": "FibreLight 1GB:1GB",  "cost": 90.00, "install": 152.00},
        ],
        "constants": {
            "vc_cost_per_seat": 3.49,
            "wallboard_sell": 4.99,
...
PRODUCT_IMAGES = {
    "Fanvil V66":             "images/fanvil_v66.jpg",
    "Fanvil V66 Pro":         "images/fanvil_v66_pro.jpg",
    "Fanvil V62W":            "images/fanvil_v62w.jpg",
    "Yealink T85w":           "images/yealink_t85w.jpg",
    "Yealink T87w":           "images/yealink_t87w.jpg",
    "Yealink T57w":           "images/yealink_t57w.jpg",
    "Yealink T58w Pro":       "images/yealink_t58w_pro.jpg",
    "Grandstream GXV3470":    "images/grandstream_gxv3470.jpg",
    "Grandstream GXV3480":    "images/grandstream_gxv3480.jpg",
    "Yealink CP925 (Conf.)":  "images/yealink_cp925.jpg",
    "Yealink CP965 (Conf.)":  "images/yealink_cp965.jpg",
    "Linkvil W610W":          "images/linkvil_w610w.jpg",
    "Linkvil W620W (Rugged)": "images/linkvil_w620w.jpg",
    "Yealink AX83H":          "images/yealink_ax83h.jpg",
    "Yealink AX86R (Rugged)": "images/yealink_ax86r.jpg",
    "Yealink W57R (Rugged)":  "images/yealink_w57r.jpg",
    "Yealink W73H":           "images/yealink_w73h.jpg",
    "Yealink W70B (Base)":    "images/yealink_w70b.jpg",
...
rental_discount = 0.0
hw_fund        = "None"
is_recurring   = True   # Always recurring — no lease
...
def compute_service_charges():
    ...
    vc_sell_per_seat = round(C["vc_cost_per_seat"] * (1.0 + uplift), 3)
    lic_monthly      = total_voice_channels * vc_sell_per_seat
    wallboard_mo     = wallboard_users * C["wallboard_sell"]
